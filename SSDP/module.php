 ...
 */
class SSDPNEEO extends IPSModule
{
	...
	public function Create()
	{
		...
		//$this->RegisterTimer('SendNotify', 0, 'SSDPNEEO_TimerNotify($_IPS[\'TARGET\']);');
	...
	public function ApplyChanges()
	{
		...
		$this->RegisterHook('/hook/neeodiscovery' . $this->InstanceID);
	...
	protected function SendNotify(int $serverport)
	{
		...
		$SendData = Array("DataID" => "{C8792760-65CF-4C53-B5C7-A30FCC84FEFE}", "Buffer" => utf8_encode($Payload), "ClientIP" => "239.255.255.250", "ClientPort" => 1900);
...
';
  ...
  <app id="28">Pandora</app>
		...
		$mapping = array("Rev" => 1, "Fwd" => 2, "Play" => 3, "Back" => 4, "Home" => 5, "Info" => 6, "Up" => 7, "Down" => 8, "Right" =>9, "Left" => 10, "Select" =>11, "InstantReplay" =>12, "Search" =>13);
