...
define('NEEOBINDING_BINDING_ID', "neeo");
define('NEEOBINDING_DEVICE_ID', NEEOBINDING_BINDING_ID . ":device");
define('NEEOIO_BINDING_ID', "neeo_io");
define('VIRTUAL_THING_TYPE', "virtual");
define('THREAD_POOL_NAME', "neeoio");
define('WEBAPP_PREFIX', "/neeo");
define('WEBAPP_DASHBOARD_PREFIX', "/neeostatus");
define('NEEO_MDNS_TYPE', "_neeo._tcp.local.");
define('CFG_EXPOSE_ALL', "exposeAll");
define('CFG_EXPOSENEEOBINDING', "exposeNeeoBinding");
define('CFG_CHECKSTATUSINTERVAL', "checkStatusInterval");
define('CFG_LOCALIPADDRESS', "localIpAddress");
define('CFG_SEARCHLIMIT', "searchLimit");
define('ADAPTER_NAME', "Symcon");
define('DEFAULT_BRAIN_PORT', 3000); // The default port the brain listens on.
define('PROTOCOL', "http://");
define('SEARCH_MATCHFACTOR', 0.5);
define('NEEO_VERSION', "/v1");
define('REGISTER_SDK_ADAPTER', NEEO_VERSION . "/api/registerSdkDeviceAdapter");
define('UNREGISTER_SDK_ADAPTER', NEEO_VERSION . "/api/unregisterSdkDeviceAdapter");
define('PROJECTS_HOME', NEEO_VERSION . "/projects/home");
define('RECIPES', NEEO_VERSION . "/api/recipes");
define('SYSTEMINFO', NEEO_VERSION . "/systeminfo");
define('NOTIFICATION', NEEO_VERSION . "/notifications");
define('CAPABILITY_PATH_PREFIX', "/device");
define('DEFAULT_SYMCON_PORT', 3777);
